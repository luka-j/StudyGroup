...
public class Adder {
    ...
    public static void addCourse(ID group, String name, String teacher, String year, File image) {
        Log.i(TAG,
              "Add course: " + name + " by " + teacher + ", y" + year + " with image "
              + getNullableFilePath(image));
    }

    public static void addNote(ID course, String lesson, String note, File imageFile, File audioFile) {
        Log.i(TAG, "Add note: lesson " + lesson + "\nNote: " + note + "\nFiles: image "
                   + getNullableFilePath(imageFile) + ", audio: " + getNullableFilePath(audioFile));
    }

    public static void addQuestion(ID course, String lesson, String question, String answer,
                                   File imageFile) {
        Log.i(TAG,
              "Add question: lesson " + lesson + "\nQuestion: " + question + "\nAnswer: " + answer
    ...
    private static String getNullableFilePath(File f) {
        if (f == null) { return "null"; } else return f.getAbsolutePath();
    }
}
