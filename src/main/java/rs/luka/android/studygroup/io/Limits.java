 ...
 */
public class Limits {
    public static final int COURSE_NAME_MAX_LENGTH    = 127;
    public static final int COURSE_TEACHER_MAX_LENGTH = 127;
    public static final int COURSE_YEAR_MAX           = 255;
    public static final int COURSE_YEAR_MIN           = 0;
    public static final int LESSON_MAX_LENGTH         = 127;
